...
class StatsDashboard:
    ...
    def _print_dashboard(self) -> None:
        ...
        if self.global_stats.injection_attempts > 0:
            success_rate = (
                self.global_stats.successful_injections / self.global_stats.injection_attempts * 100
            )
    ...
    def print_summary(self) -> None:
        ...
        if self.target_stats:
            ...
            for ip, stats in self.target_stats.items():
                print(
                    f"  {ip}: {stats.successful_injections}/{stats.injections_attempted} injections"
                )
